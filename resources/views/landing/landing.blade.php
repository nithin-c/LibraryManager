...
<head>
    ...
    <!-- Theme CSS -->
    <link href="/landing/css/grayscale.min.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <i class="fa fa-play-circle"></i> <span class="light">Library</span> Manager
                </a>
            </div>
    ...
    <!-- jQuery -->
    <script src="/landing/vendor/jquery/jquery.js"></script>
    ...
    <!-- Theme JavaScript -->
    <script src="/landing/js/grayscale.min.js"></script>
